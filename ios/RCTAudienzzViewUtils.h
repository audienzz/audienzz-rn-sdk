...
/// Returns the root view controller of the app's key window using the scene API (iOS 13+),
...
/// Prefer the window that actually contains the ad in multi-window apps.
+ (UIViewController *_Nullable)rootViewControllerForView:(UIView *_Nonnull)view;
