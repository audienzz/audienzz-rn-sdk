...
#import "RCTOriginalInterstitialViewManager.h"
#import "RCTOriginalInterstitialView.h"
#import <React/RCTViewManager.h>

@implementation RCTOriginalInterstitialViewManager

RCT_EXPORT_MODULE(RCTOriginalInterstitialView)

- (UIView *)view {
    return [[RCTOriginalInterstitialView alloc] init];
}
...
RCT_EXPORT_VIEW_PROPERTY(impOrtbConfig, NSString)
