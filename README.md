...
| `adFormats`               | This ad unit formats for the current ad unit. **Default:** `OriginalBanner` → (Multiformat) `[‘banner’, ‘video’]`; `OriginalInterstitial` → `[‘banner’]` (display-only; add `‘video’` to opt into video interstitials).                                                                                                                                                                                                                                               |    No    | Array<’banner’ &#124; ‘video’>                                                                                                                                                                                                | `OriginalBanner`, `OriginalInterstitial`                     |
