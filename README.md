  ...
  OriginalRewarded,
   ...
   ...
    ...
    <OriginalRewarded
      adUnitID="adUnitID"
      auConfigID="adUnitID"
      onRewardEarned={(event) => console.log(`The user received -> ${JSON.stringify(event, null, 2)}`)}
...
| `onRewardEarned`          | A callback triggered when a reward for viewing an ad is received.                                                                                                                                                                                                                                                                             | **YES**  | onRewardEarned(reward: {type: string, amount: number}): void                                                                                                                                                                  | `OriginalRewarded`                                           |
...
| `onAdClosed`              | A callback triggered when the user is about to return to the app after clicking on an ad.                                                                                                                                                                                                                                                     |    No    | onAdClosed?(): void                                                                                                                                                                                                           | `OriginalBanner`, `OriginalInterstitial`, `OriginalRewarded` |
  ...
  RenderingRewarded,
   ...
   ...
    ...
    <RenderingRewarded
      adUnitID="adUnitID"
      auConfigID="adUnitID"
      onRewardEarned={() => console.log('The user can receive reward (own implementation) -> 💰')}
      onAdLoaded={() => console.log('REWARDED success')}
      onAdFailedToLoad={(error) => console.log(`REWARDED ERROR -> ${JSON.stringify(error, null, 2)}`)}
    />
...
| `onRewardEarned`     | A callback triggered when a reward for viewing an ad is received.                                                                                                                                                                                                                                                                             | **YES**  | onRewardEarned(): void                                          | `RenderingRewarded`                                             |
...
| `skipDelay`          | Sets delay in seconds to show close button. **Default:** `15`.                                                                                                                                                                                                                                                                                |    No    | number                                                          | `RenderingInterstitial`                                         |
...
| `onAdClosed`         | A callback triggered when the user is about to return to the app after clicking on an ad.                                                                                                                                                                                                                                                     |    No    | onAdClosed?(): void                                             | `RenderingBanner`, `RenderingInterstitial`, `RenderingRewarded` |
